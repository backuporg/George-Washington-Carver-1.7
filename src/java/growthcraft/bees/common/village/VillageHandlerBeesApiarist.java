...
public class VillageHandlerBeesApiarist implements IVillageTradeHandler, IVillageCreationHandler
{
	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random)
	{
		...
		recipeList.add(new MerchantRecipe(new ItemStack(Items.honeyJar, 4, 6), new ItemStack(Items.emerald, 2, 3)));
		recipeList.add(new MerchantRecipe(new ItemStack(Items.honeyCombFilled, 4, 6), new ItemStack(Items.emerald, 2, 3)));
		recipeList.add(new MerchantRecipe(new ItemStack(Items.bee, 4, 6), new ItemStack(Items.emerald, 1, 2)));
		recipeList.add(new MerchantRecipe(new ItemStack(Items.beesWax, 1, 2), new ItemStack(Items.emerald, 2, 4)));
	}
