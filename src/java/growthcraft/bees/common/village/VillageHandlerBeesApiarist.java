...
public class VillageHandlerBeesApiarist implements IVillageTradeHandler, IVillageCreationHandler
{
	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random)
	{
		...
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.honeyJar, 1 + random.nextInt(2)), new ItemStack(Items.emerald, 2)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.honeyCombFilled, 1 + random.nextInt(2)), new ItemStack(Items.emerald, 2)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.bee, 1 + random.nextInt(2)), new ItemStack(Items.emerald, 1)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.beesWax, 1 + random.nextInt(2)), new ItemStack(Items.emerald, 4)));
	}
