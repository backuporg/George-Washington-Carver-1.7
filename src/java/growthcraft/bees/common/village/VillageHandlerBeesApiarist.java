...
public class VillageHandlerBeesApiarist implements IVillageTradeHandler, IVillageCreationHandler
{
	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random)
	{
		...
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.honeyJar.asStack, 4, 6), new ItemStack(Items.emerald, 2, 3)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.honeyCombFilled.asStack, 4, 6), new ItemStack(Items.emerald, 2, 3)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.bee.asStack, 4, 6), new ItemStack(Items.emerald, 1, 2)));
		recipeList.add(new MerchantRecipe(new ItemStack(GrowthCraftBees.items.beesWax.asStack, 1, 2), new ItemStack(Items.emerald, 2, 4)));
	}
